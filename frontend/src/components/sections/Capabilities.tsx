...
const CAPABILITIES = [
  {
    ...
    desc: 'Cellular automata hydrodynamic engine, 512² grid, 60fps in-browser',
    popupText: 'Hydrodynamic flow engine operates at 60Hz. Cellular automata calculates velocity, depth, and spread rate dynamically over the loaded DEM.',
  },
  {
    id: '02',
    title: 'CASCADING IMPACT',
    desc: 'Roads, bridges, hospitals, population flagged live',
    popupText: 'Graph database intersections instantly flag critical infrastructure. Population density heatmaps correlate with the flood vector in real time.',
  },
  {
    id: '03',
    title: 'SCENARIO COMPARISON',
    desc: 'Breach presets, baseline vs live, SPH-style particle visualization',
    popupText: 'A/B simulation engine allows instant switching between breach width, depth, and structural failure severity parameters.',
  },
  {
    id: '04',
    title: 'EXPORT & VALIDATION',
    desc: '.KML / .SHP export, Sentinel-1 validation via Google Earth Engine',
    popupText: 'Automated data packaging for ground teams. Inundation polygons are strictly validated against latest SAR imagery telemetry.',
  }
];
