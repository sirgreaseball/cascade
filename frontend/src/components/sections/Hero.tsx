        ...
        <div className="flex-1 flex flex-col justify-center max-w-[90vw] mx-auto w-full px-4 md:px-12">
          ...
          <div className="mt-20 flex flex-col items-start pointer-events-auto opacity-0 hud-element">
            ...
            <div className="mt-8 ml-2">
              <a href={REPO_URL} target="_blank" rel="noreferrer" className="font-mono text-[11px] tracking-[0.3em] text-white/80 hover:text-white transition-colors cursor-hover uppercase block">
                Read the brief &rarr;
              </a>
            </div>
          </div>
