...
export default function Manifesto() {
  ...
  const text = "A dam break releases millions of cubic metres in minutes. CASCADE simulates the inundation in the browser — terrain, water, roads, homes — before the water arrives.";
